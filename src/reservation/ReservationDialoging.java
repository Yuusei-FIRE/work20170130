...
public class ReservationDialoging extends Dialog implements ActionListener, WindowListener,ItemListener {
 ...
 // パネル
   Panel panelNorth;
	...
	public ReservationDialoging(Frame owner) {
			...
			((Choice) choiceFacility).addItemListener(this);
